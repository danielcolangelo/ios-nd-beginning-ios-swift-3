...
*/
let wilsonRawls = Author.init(firstName: "Wilson", lastName: "Rawls", living: false)
let whereTheRed = book.init(title: "Where the red firn", author: wilsonRawls, pages: 245, numberOfStars: 4.5, description: "about a young boy and his hunting dog", genre: "fiction")


let johnTolkien = Author.init(firstName: "John", lastName: "tolkien", living: false)
let theHobbit = book.init(title: "the Hobbit", author: johnTolkien, pages: 300, numberOfStars: 5, description: "a treasure seeking quest", genre: "fantasy")

let maryShelly = Author.init(firstName: "Mary", lastName: "Shelly", living: false)
let frankenstein = book.init(title: "frankenstein", author: maryShelly, pages: 280, numberOfStars: 4.7, description: "making a creature", genre: "fantasy")
